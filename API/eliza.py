...
class Eliza:
    ...
    def respond(self, text):
        ...
        # Something here to make the emotions be used in generating
        # the output text within this for loop. It may need to be done 
        # in _match_key() as a parameter. Ensure the output is generated by emotions
        for key in keys:
